  ...
  return (
    <>
      ...
      <div className="about-container">
        ...
        <br /> This resource was born of a desire to bring essential information
        about composers easily to your fingertips. Populated with the most
        searched composers of Wikipedia, this unstructured data was compiled and
        transformed to offer names, birth and death years, nationality and
        musical eras for the most popular composers.
        <br />
        <br />I plan to extend the database with additional information. If you
        have ideas, please contact me at my website or email above! <br /> And
        now, my credentials:
        <br />
        <figure>
